...
export default function Footer() {
  return (
    <div className="flex flex-col justify-between h-screen bg-[#1e1e1e] px-20 py-10 pt-20">
      <div className="flex items-center justify-between">
        <a
          href="#"
          className="uppercase font-semibold text-4xl text-white w-1/3"
          style={{ fontFamily: "cursive" }}
        >
          Beston
        </a>
        <div className="flex flex-col border-b border-[#86868b] group cursor-pointer relative w-[60%]">
      ...
      <div className="pt-20">
        ...
        <div className="flex justify-between">
          <div>
            ...
            <br />
            <a
              className="text-4xl font-semibold text-white pt-3 inline-block"
              href="#"
            >
              info@beston.uz
            </a>
      ...
      <div className="border-t  border-[#86868b] pt-4 mt-20 flex items-center justify-between">
